...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <column label="缩略图地址" name="fThumb" type="String" xid="xid6"></column>
  <filter name="filter0" xid="filter3"></filter>
  <filter name="filter1" xid="filter4"></filter></div>  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
   ...
   <div class="x-contents-content x-scroll-view" xid="picContent">
    <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView2" pullUpLabel="上拉加载..." autoPullUp="false">
   ...
   <div class="x-col" xid="col1"><div component="$UI/system/components/justep/output/output" xid="output1" bind-ref='ref("fUserName")' style="font-size:medium;font-weight:bold;font-family:方正舒体;font-style:normal;text-decoration:none;color:#000000;"></div></div>
   </div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
   <div component="$UI/system/components/justep/output/output" class="x-output list-group-item-text fenhang" xid="output3" bind-ref='ref("fDescription")' style="font-family:华文隶书;font-size:medium;text-overflow:ellipsis;"></div></div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row3">
   
  <div class="x-col" xid="col9"><div xid="div2" style="overflow:hidden;background-repeat:no-repeat;background-position:center center;width:100%;height:200px;"><img alt="" xid="image" dir="rtl" bind-attr-src=' val("fThumb")' class="media-object" style="width:100%;" height="auto"></img></div></div></div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
   <div class="x-col" xid="col3"><div component="$UI/system/components/justep/output/output" class="x-output list-group-item-text" xid="output2" bind-ref='ref("fCreateTime")' style="font-weight:bold;font-family:华文细黑;color:#999;text-align:right;" format="yyyy-MM-dd hh:mm"></div></div></div></div> 
  </div> 
  </li> </ul> </div> 
  <input component="$UI/system/components/justep/input/input" class="form-control" xid="input1" bind-ref='$model.data.ref("fileName")' style="visibility:hidden;"></input></div> 
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon uploadbtn" label="button" xid="button2" icon="round round-plus" onClick="chooseSheetPhoto">
    <i xid="i1" class="round round-plus" style="width:60;"></i>
