...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:100px;top:109px;"
    ...
    <div component="$UI/system/components/justep/data/baasData" autoLoad="true"
      ...
      tableName="pai_pictures" url="/justep/pai" idColumn="fID" confirmRefresh="false" confirmDelete="false" directDelete="true" limit="-1"> 
  ...
  <column label="上传者姓名" name="fUserName" type="String" xid="xid2"></column>
  <column label="fTaskID" name="fTaskID" type="String" xid="xid3"></column></div> 
  </div>  
